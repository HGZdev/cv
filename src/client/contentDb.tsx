...
export const aboutGithubInvitationCV = (
  <p>
    ...
    <a
      target="_blank"
      href={github}
      className="underline underline-offset-2 under text-[#252F51] hover:text-[#4e5e91]"
    >
      GitHub portfolio
    </a>
    .
...
export const techSection: SectionProps = {
  ...
  blocks: [
    {
      list: [
        {Icon: BiLogoTypescript, title: "TypeScript", stars: 4},
        {Icon: GrReactjs, title: "React.js", stars: 5},
        {Icon: SiWebpack, title: "Webpack", stars: 4},
        {Icon: SiVite, title: "Vite", stars: 3},
        {Icon: SiQwik, title: "Qwik", stars: 2, hidden: true},
      ],
    },
    {
      list: [
        {Icon: DiHtml5, title: "HTML", stars: 5, hidden: true},
        {Icon: DiCss3Full, title: "CSS", stars: 5, hidden: true},
        {Icon: RiTailwindCssLine, title: "Tailwind CSS", stars: 4},
        {
          Icon: SiStyledcomponents,
          title: "Styled-comp.",
          stars: 5,
        },
        {Icon: FaSass, title: "SASS", stars: 3, hidden: true},
      ],
    },
    {
      list: [
        ...
        {Icon: BiLogoRedux, title: "Redux", stars: 3, hidden: true},
      ],
    },
    {
      list: [
        ...
        {Icon: SiCypress, title: "Cypress.js", stars: 3},
      ],
    },
  ],
};
...
export const toolsSection: SectionProps = {
  ...
  blocks: [
    {
      list: [
        {Icon: FaGitSquare, title: "Git", stars: 4},
        ...
        {Icon: SiCoreldraw, title: "COREL Photo", stars: 3, hidden: true},
      ],
    },
  ],
};
...
export const jobBlock: BlockProps[] = [
  ...
  {
    title: "TNS Polska S.A. – Automotive Department",
    subtitle: "Junior Research Executive",
    startDate: "05.2013",
    endDate: "05.2015",
    list: [
  ...
  {
    title: "ACNielsen Polska Sp. z o.o. – Manufacturer Client Service",
    subtitle: "Marketing Research Consulting Programme",
    startDate: "09.2012",
    endDate: "03.2013",
    list: [
  ...
  {
    title: "L’Oreal Polska Sp. z o.o. – Media and Market Research Division",
    subtitle: "Internship",
    startDate: "06.2010",
    endDate: "12.2010",
