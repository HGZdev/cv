...
const translations: Translations = {
  ...
  about_text_paragraph_1: {
    ...
    pl: "Jestem programistką z siedmioletnim doświadczeniem w tworzeniu aplikacji webowych. Specjalizuję się w technologiach front-end, ale bliskie są mi rownież zagadnienia back-endowe.",
  },
  about_text_paragraph_2: {
    en: "Throughout my career, I have been involved in creating user interfaces, managing client-server communication, co-designing database architectures, testing, and occasionally managing projects. My prior experience in the market research industry enhanced my skills in working with business clients and has taught me how to effectively translate their needs into functional requirements.",
    pl: "W toku mojej kariery zawodowej zajmowałam się tworzeniem interfejsów użytkownika i ich testowaniem, zarządzaniem komunikacją klient-serwer, współpracowałam przy tworzeniu architektury baz danych, a także, okazjonalnie, zarządzałam projektami. Moje wcześniejsze doświadczenie zdobyte w branży badań rynkowych pomogło mi rozwinąć umiejętności pracy z klientami biznesowymi oraz nauczyło mnie skutecznie tłumaczyć ich potrzeby na język funkcjonalności.",
  },
  ...
  about_github_invitation_text: {
    ...
    pl: "Uprzejmie zapraszam do zapoznania się z moim",
  },
  ...
  personal_github_title: {
    en: "GitHub",
    pl: "GitHub",
  },
  personal_linkedin_title: {
    en: "LinkedIn",
    pl: "LinkedIn",
  },
  hobbies_headline: {
  ...
  hobbies_desc: {
    en: "DIY wonders, old worlds, new places",
    pl: "rękodzieło, dawne światy, nowe miejsca",
  },
  languages_headline: {
    en: "Languages",
    pl: "Języki",
  },
  languages_polish_title: {
    en: "Polish",
    pl: "Polski",
  },
  languages_english_title: {
    en: "English",
    pl: "Angielski",
  },
  languages_native_desc: {
    en: "Native",
    pl: "Ojczysty",
  },
  languages_advanced_desc: {
    en: "Advanced",
    pl: "Zaawansowany",
  },
  technologies_headline: {
    en: "Technologies",
    pl: "Technologie",
  },
  ...
  technologies_html_title: {
    en: "HTML",
    pl: "HTML",
  },
  technologies_css_title: {
    en: "CSS",
    pl: "CSS",
  },
  ...
  technologies_firebase_title: {
    en: "Firebase",
    pl: "Firebase",
  },
  technologies_qwik_title: {
    en: "Qwik",
    pl: "Qwik",
  },
  technologies_redux_title: {
    en: "Redux",
    pl: "Redux",
  },
  ...
  tools_affinity_photo_title: {
    en: "Affinity Photo",
    pl: "Affinity Photo",
  },
  tools_corel_photo_title: {
    en: "Corel Photo",
    pl: "Corel Photo",
  },
  tools_vscode_title: {
  ...
  jobs_yaska_responsibility_2: {
    ...
    pl: "Tworzenie interfejsów użytkownika i ich testowanie (React.js, Final-form, styled-components, Jest, Cypress.js).",
  },
  ...
  jobs_loreal_responsibility_1: {
    ...
    pl: "Analiza rynku kosmetycznego i koordynacja badań po stronie klienta.",
  },
  education_title: {
    en: "education",
    pl: "wykształcenie",
  },
  education_education_title: {
    en: "Education",
    pl: "Edukacja",
  },
  education_tag_1: {
  ...
  education_tag_2: {
    ...
    pl: "Ekonomia Przedsiębiorczości",
  },
  education_tag_3: {
    en: "Social and Market Research",
    pl: "Badania Społeczne i Rynkowe",
  },
  education_workshops_title: {
    en: "Workshops & Trainings",
  ...
  workshops_open_university_title: {
    ...
    pl: "Otwarty Uniwersytet Warszawski – Kurs MS Excel i VBA",
  },
  workshops_open_university_text: {
    en: "MS Excel Work Automation with Macros and VBA (60 hours).",
    pl: "Automatyzacja pracy w MS Excel za pomocą makr i VBA (60 godzin).",
  },
  date_ongoing: {
    en: "Ongoing",
    pl: "Obecnie",
  ...
  key_skills_headline: {
    en: "Key Skills & Technologies",
    pl: "Kluczowe Umiejętności i Technologie",
  },
  skills_headline: {
    en: "Skills",
    pl: "Umiejętności",
  ...
  experience_tag_4: {
    ...
    pl: "Doświadczenie w Badaniach Rynkowych",
  },
  work_experience_headline: {
    en: "Work Experience",
    pl: "Doświadczenie Zawodowe",
  },
  workshops_trainings_headline: {
    en: "Workshops & Trainings",
    pl: "Warsztaty i Szkolenia",
  },
  education_headline: {
